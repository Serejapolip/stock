...
class Product(models.Model):
    ...
    owner = models.ForeignKey(ApiUser, related_name='products', on_delete=models.CASCADE)
...
class Business(models.Model):
    user = models.ForeignKey(ApiUser, related_name="business_actions", on_delete=models.CASCADE)
    product = models.ForeignKey(Product, related_name="business_actions", on_delete=models.CASCADE)
    quantity = models.IntegerField()
